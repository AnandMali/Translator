package com.anandmali.translator.presentation.ui.view
...
import com.anandmali.translator.presentation.util.SupportedLanguage
import com.anandmali.translator.presentation.util.supportedLanguages
import com.anandmali.translator.presentation.state.UiState
import com.anandmali.translator.presentation.ui.theme.TranslatorTheme
import com.anandmali.translator.presentation.vm.TranslatorViewModel
...
fun TranslatorScreen(
    ...
    val speechRecognizedLanguage by translatorViewModel.speechLanguage.collectAsState()

    println("View translator screen")
    ...
    Column(
        ...
        ExtendedFloatingActionButton(
            onClick = {
                launchSpeechRecogniser { result ->
                    ...
                    translatorViewModel.getLanguageOfText(result)
                }
            },
        ...
        TranslateButton {
            translatorViewModel.translateText(
...
fun SelectLanguageToTranslate(
    ...
    languageSelected: (supportedLanguage: SupportedLanguage) -> Unit
) {
    Column {
        Text(
        ...
        Box(
            ...
            Row(
                ...
                Text(
                    text = currentSupportedLanguage.displayName,
